...
class correlation:
    ...
    def __init__(self, numer):
        ...
        self.symmetry="Rhombo"
        self.dimention_x, self.dimention_y, self.dimention_z=5, 5, 5
        self.anglestep_p=1080
        self.anglestep_t=1080
        self.sizestep=200
        self.numer=numer
        with open("/nfshome/khachaturyan/Publication/3D_cube/cube_simulation/calculated/{}_cor/E_P_cor_{}.out".format(self.symmetry,self.numer),"r") as f:
            content=f.readlines()
            for line in content:
                if "Time" in line:
    ...
    def correlations(self):
        ...
        path_to="/nfshome/khachaturyan/Publication/3D_cube/cube_simulation/calculated/"
        P,E,p0=self.readFlexpdeoutput(path_to+'{}_cor/E_P_cor_{}.out'.format(self.symmetry,self.numer))
        ...
        Px1=[[] for _ in range(self.sizestep)]
        Pz1=[[] for _ in range(self.sizestep)]
        ...
        for n in range(self.anglestep_t):
            ...
            Px2=[[] for _ in range(self.sizestep)]
            Pz2=[[] for _ in range(self.sizestep)]
